from platoon.envs.countdown.tasks import get_task
from platoon.generators.types import RolloutGeneratorConfig
from platoon.envs.countdown.env import CountDownEnv
from platoon.agents.countdown.agent import CountDownAgent
...
def run_single_rollout_process(args: tuple[str, dict]) -> dict:
    ...
    async def run_rollout() -> dict:
        ...
        try:
            ...
            agent = CountDownAgent(llm_client=llm_client)
